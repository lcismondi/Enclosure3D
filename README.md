# Enclosure3D
Me puse a diseñar un control de ambiente para un gabinete de impresión 3D y así mejorar la calidad de impresión, puedes ver más novedades en mis redes [Instagram](https://instagram.com/lucianociri) y [TikTok](https://www.tiktok.com/@luciano.ciri).
...
# Compatibilidad
Como no todo sucede al mismo tiempo y en el mismo orden, veamos qué cosa es compatible con qué.

| [Firmware](./Firmware/Versiones.md) | [PCB](./PCB/VersionPCB.md)  | [Carcasa](./Carcasa/Versiones.md)  | Software |
| :--: | :--: | :--: | :--: |
| 0.0 | 0.0 | 0.0 | - |
| 0.1 | 0.1 | 0.1 | - |
| 0.2 | 0.2 | 0.2 | - |
